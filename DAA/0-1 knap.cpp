...
{   
    ...
    // Skip the Item
    int notPick = 0 + memoized(index-1,n,bagWeight,profits,weights,dp); 
    
    // Pick the Item
    int pick = -1000000; // Initialize with Lower Value
    if(bagWeight>=weights[index])
    {
        pick = profits[index] + memoized(index-1,n,bagWeight-weights[index],profits,weights,dp);
    }
...
{   
    ...
    int profits[] = {100,60,100, 200};     // Profit from Each item
    int weights[] = {20,10,50, 50};        // Weight of Each item
    int bagWeight = 90;
    ...
    // int n = 3;
    // int profits[] = {10, 50, 70};
    // int weights[] = {5, 15, 20};
    // int bagWeight = 20;

    // int n = 4;
    // int profits[] = {20, 30, 40, 50};
